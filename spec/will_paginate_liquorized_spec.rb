describe 'Will Paginate Liquorized' do
  
  before(:each) do
    # setup
  end
  
  describe "liquorized collection drops" do
    
    it "should return Collection Drop for collection to_liquor"
    #do
      #@collection.to_liquid.class.should eql(WillPaginate::Liquorized::CollectionDrop)
    #end
  ...
  describe "html pagination" do
    ...
    it "should render successfully from liquor template"
